<div id="carouselExampleIndicators" class="carousel slide home-slider" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="http://<?=$_SERVER['HTTP_HOST']?>/Images/Work9.jpg" height="600px" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block mb-5">
        <h2 class="text-dark">Your Trusted Contracting Partner</h2>
        <p> <a role='button' href="http://<?=$_SERVER['HTTP_HOST']?>/contact-us.php" type="button" class="btn btn-outline-dark btn-lg rounded-pill">Contact Us</a> </p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="http://<?=$_SERVER['HTTP_HOST']?>/Images/work5.jpg" height="600px" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block mb-5">
        <h2 class="text-dark">Valuing your Time & Money</h2>
        <p> <a role='button' href="http://<?=$_SERVER['HTTP_HOST']?>/contact-us.php" type="button" class="btn btn-outline-dark btn-lg rounded-pill">Contact Us</a> </p>
      </div>
    </div>
  </div>
