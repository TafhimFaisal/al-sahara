<!-- <div class="container">
    <div class="cctv">
        <h1> CCTV Services </h1>
        <p>
            We are committed to give the customers a seamless experience in installation,
            configuration, maintenance and upkeep, upgradation, repairs and more for their electronic security, surveillance equipment and robust cabling network. 
        </p>


        <h1> Supply & Installation </h1>
        <p>
        ...
        <p>
            We offer comprehensive maintenance contracts for our clients that include preventive maintenance,       
            regular repairs, system expansion, upgrades and more of both your hardware and software systems. Since we are conveniently located in the heart of UAE, our team will reach you in record time so that you enjoy minimal downtime.
        </p>
